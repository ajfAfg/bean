...
group_test_() ->
    {inparallel,
     [{"Longest straight paths are grouped as `rest_for_one`",
      ...
      {"Disconnected components are grouped as `one_for_one`",
       ?_assertEqual({one_for_one, [gen_server2, gen_server1]},
                     gen_server_dependencies:group(#{gen_server1 => [], gen_server2 => []}))}]}.
